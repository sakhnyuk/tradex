...
import { ChartTimeframe, ExchangeName, OrderBookUpdateType, TradeSide } from 'lib/core/types';
import {
  BinanceTradeDto,
  BinanceTradeStream,
  CandleUpdatePayload,
...
export class BinanceAdapter implements ExchangeProvider {
  ...
  private defaultTimeframe: ChartTimeframe = '60';
  ...
  private streamUrls = {
    ...
    kline: (symbol: TradeSymbol, timeframe: ChartTimeframe): string =>
